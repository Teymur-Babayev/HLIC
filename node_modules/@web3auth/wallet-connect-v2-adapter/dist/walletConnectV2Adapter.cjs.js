...
module.exports = self.fetch || (self.fetch = (__webpack_require__(8247)["default"]) || __webpack_require__(8247));
...
class n extends events/* IEvents */.q{constructor(s){super(),this.opts=s,this.protocol="wc",this.version=2}}class index_es_l{constructor(s,t,o){this.core=s,this.logger=t}}class index_es_h extends events/* IEvents */.q{constructor(s,t){super(),this.core=s,this.logger=t,this.records=new Map}}class a{constructor(s,t){this.logger=s,this.core=t}}class u extends events/* IEvents */.q{constructor(s,t){super(),this.relayer=s,this.logger=t}}class g extends events/* IEvents */.q{constructor(s){super()}}class p{constructor(s,t,o,M){this.core=s,this.logger=t,this.name=o}}class I{constructor(){this.map=new Map}}class d extends events/* IEvents */.q{constructor(s,t){super(),this.relayer=s,this.logger=t}}class index_es_x{constructor(s,t){this.core=s,this.logger=t}}class index_es_E extends events/* IEvents */.q{constructor(s,t){super(),this.core=s,this.logger=t}}class m{constructor(s,t){this.logger=s,this.core=t}}class index_es_y{constructor(s,t){this.projectId=s,this.logger=t}}class v{constructor(s,t){this.projectId=s,this.logger=t}}class index_es_C extends (/* unused pure expression or super */ null && (c)){constructor(){super()}}class b{constructor(s){this.opts=s,this.protocol="wc",this.version=2}}class S extends (/* unused pure expression or super */ null && (i)){constructor(){super()}}class w{constructor(s){this.client=s}}
//# sourceMappingURL=index.es.js.map
...
class WalletConnectV2Adapter extends base_evm_adapter_namespaceObject.BaseEvmAdapter {
  ...
  cleanupPendingPairings() {
    ...
    if (!index_es_k(inactivePairings)) return;
